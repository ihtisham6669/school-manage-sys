...
const Alert = ({message,status,type}) => {
  return (
    <section className={`${status==='noRes'?'-translate-y-full duration-300 ease-out':'translate-y-0 ease-in duration-300'} flex flex-col justify-center items-center p-4 rounded-xl absolute top-0 w-full h-screen left-0 bg-sky-950/30 backdrop-blur-md z-50`}>
