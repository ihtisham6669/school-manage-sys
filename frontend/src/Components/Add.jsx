      ...
      <form onSubmit={handleSubmit}>
        <div className="flex justify-center flex-col items-start flex-wrap gap-6 " >
          <div className="w-full">
            <label className="text-cyan-500 font-medium text-lg " htmlFor="name">
              Name
            </label>
            <input
              id="name"
          ...
          <div className="w-full" >
            <label className="text-cyan-500 font-medium text-lg  " htmlFor="course">
              Course
            </label>
            <input
              id="course"
          ...
          <div className="w-full">
            <label className="text-cyan-500 font-medium text-lg  " htmlFor="joindate">
              Join Date
            </label>
            <input
              id="joindate"
